...
const questions = [
  ...
  {
    question: "What is your current level of understanding of the Base blockchain?",
    options: [
      "I'm completely new to blockchain and Base.",
      "I have a basic understanding of blockchain concepts.",
      "I know a bit about Base and its features.",
      "I'm familiar with Base and have worked with it before.",
    ],
    type: "multiple",
  },
  {
    question: "Have you interacted with smart contracts on Base?",
    options: [
      "No, I haven't worked with smart contracts.",
      "I've read about them but haven't tried.",
      "I have created a few smart contracts on Base.",
      "I'm experienced with developing smart contracts on Base.",
    ],
    type: "multiple",
  },
  {
