...
import { ArrowBigLeft, SendToBack, Share2 } from "lucide-react";
...
export const Rookie = () => {
  ...
  return (
    <div>
      <div className="my-2">
        <Button onClick={handleHome} className="rounded-full bg-slate-700">
          <ArrowBigLeft />
        </Button>
      </div>
      ...
      <Card className="bg-[url('/icons/module-bg.jpeg')] bg-cover bg-center h-[85vh] w-full mt-8 text-white bg-opacity-10">
        <CardContent className="grid grid-cols-2 gap-10 items-center justify-center p-10">
          {/* Level 1 */}
          <div className="flex flex-col gap-3 cursor-pointer" onClick={handleNavigate}>
          ...
          {/* Level 2 */}
          <div className="flex flex-col gap-3 cursor-pointer ml-6" onClick={handleNavigate}>
          ...
          {/* Level 3 */}
          <div className="flex flex-col gap-3 cursor-pointer mt-4" onClick={handleNavigate}>
          ...
          {/* Level 4 */}
          <div className="flex flex-col gap-3 cursor-pointer mt-4 ml-6" onClick={handleNavigate}>
